...
<div class="create__quiz__heading" style="display:flex; align-items:center; justify-content:center;">
    <div class="create__quiz me-15">
        ...
        <div class="quiz__details">
            <form method="post" action="../QuizCreateAttempt/scripts/createquizscript.php">
                ...
                <!-- <select id="branch" name="branch" style="margin-left: 240px; padding-left: 25px;"> -->
                    ...
                    <option value="Electrical">Electrical and Intrumental</option>
