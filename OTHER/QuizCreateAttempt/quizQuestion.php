       ...
       ?>
            ...
            ?>
                ...
                ?>
                    ...
                    <a style="text-decoration: none; color:white;" href='../QuizCreateAttempt/resultPage1.php';?>'><button type='button' class='btn btn-dark' id='nextQuestion'>Go To Result <i class='fa-solid fa-book-arrow-right'></i></a>
                <?php
            } else {
