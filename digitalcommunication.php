...
<body>
              ...
              <img src="https://img.icons8.com/small/128/000000/settings.png" class="icons" />
                ...
                <li class="nav-item">
                    <a class="nav-link" href="login.php">
                        <p class="text-light mt-2">Login/Logout <i class="fa-solid fa-arrow-right-from-bracket p-2"></i>
                        </p>
    ...
    <div class="center">
        <div class="title">Digital Communication</div>
        <a href="Digital-Communication notes.pdf" target="_sakshi">Click to download</a>
